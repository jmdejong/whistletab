window.Tab = {
    el: this.el = document.querySelector('#tab'),
    tabTemplate: document.querySelector('#tab-entry').innerHTML,
    errorTemplate: document.querySelector('#tab-entry-error').innerHTML,
